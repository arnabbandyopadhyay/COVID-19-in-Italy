...
mkdir('Refer_pert_res')
mkdir('Refer_rt_res')
mkdir('Testing_pert_res')
mkdir('Testing_rt_res')
...
%regions = [{'italy'},{'lombardia'},{'veneto'}];
...
%                 x0=ini_init;
        ...
        %         dat=[tsave',xsave];
%         save(strcat(sprintf('Refer_pert_res/%d_%s',p_num,getfield(CN,regions{mm}))),'tsave','xsave'); %,'.mat'
        savetofile(strcat(sprintf('Refer_pert_res/%d_%s',p_num,getfield(CN,regions{mm}))),tsave,xsave);
        
%         save(strcat(sprintf('Refer_rt_res/%d_%s',p_num,getfield(CN,regions{mm}))),'rtsave','parsave'); %,'.mat'
        savetofile(strcat(sprintf('Refer_rt_res/%d_%s',p_num,getfield(CN,regions{mm}))),rtsave,parsave);
        
%         save(strcat(sprintf('Testing_pert_res/red_early_%d_%s',p_num,getfield(CN,regions{mm}))),'tsave','xTestS'); %,'.mat'
        savetofile(strcat(sprintf('Testing_pert_res/red_early_%d_%s',p_num,getfield(CN,regions{mm}))),tsave,xTestS);
        
%         save(strcat(sprintf('Testing_pert_res/red_late_%d_%s',p_num,getfield(CN,regions{mm}))),'tsave','xTestLate'); %,'.mat'
        savetofile(strcat(sprintf('Testing_pert_res/red_late_%d_%s',p_num,getfield(CN,regions{mm}))),tsave,xTestLate);
        
%         save(strcat(sprintf('Testing_rt_res/early_%d_%s',p_num,getfield(CN,regions{mm}))),'rtearly'); %,'.mat'
        savesingle(strcat(sprintf('Testing_rt_res/early_%d_%s',p_num,getfield(CN,regions{mm}))),rtearly);
        
%         save(strcat(sprintf('Testing_rt_res/late_%d_%s',p_num,getfield(CN,regions{mm}))),'rtlate'); %,'.mat'
        savesingle(strcat(sprintf('Testing_rt_res/late_%d_%s',p_num,getfield(CN,regions{mm}))),rtlate);
